...
import { Center, Flex, Space, Text, Container, Group, Paper, Grid, Button } from '@mantine/core'
                        ...
                        >
                          <Paper p="md" radius="md" style={{ background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
                            ...
                            <Text size="sm" style={{ opacity: 0.9 }}>
                              Access your food bank management system anywhere, anytime with our responsive mobile app.
                            </Text>
                          </Paper>
                        </motion.div>
                      </Grid.Col>
                      <Grid.Col span={4}>
                        ...
                        >
                          <Paper p="md" radius="md" style={{ background: 'rgba(255,255,255,0.1)', backdropFilter: 'blur(10px)' }}>
                            ...
                            <Text size="sm" style={{ opacity: 0.9 }}>
                              Track inventory levels, volunteer hours, and client statistics in real-time.
                            </Text>
                          </Paper>
                        </motion.div>
                      </Grid.Col>
                    ...
                    <Grid>
                      <Grid.Col span={3}>
                        <motion.div
                          ...
                          transition={{ duration: 0.2 }}
                        >
                          <Text size="3xl" fw={700} ta="center">500+</Text>
                          <Text size="sm" ta="center" style={{ opacity: 0.9 }}>Families Served</Text>
                        </motion.div>
                      </Grid.Col>
                      <Grid.Col span={3}>
                        <motion.div
                          ...
                          transition={{ duration: 0.2, delay: 0.1 }}
                        >
                          <Text size="3xl" fw={700} ta="center">50+</Text>
                          <Text size="sm" ta="center" style={{ opacity: 0.9 }}>Volunteers</Text>
                        </motion.div>
                      </Grid.Col>
                      <Grid.Col span={3}>
                        <motion.div
                          ...
                          transition={{ duration: 0.2, delay: 0.2 }}
                        >
                          <Text size="3xl" fw={700} ta="center">24/7</Text>
                          <Text size="sm" ta="center" style={{ opacity: 0.9 }}>Availability</Text>
                        </motion.div>
                      </Grid.Col>
                      <Grid.Col span={3}>
                        <motion.div
                        ...
                        >
                          <Text size="3xl" fw={700} ta="center">95%</Text>
                          <Text size="sm" ta="center" style={{ opacity: 0.9 }}>Satisfaction Rate</Text>
                        </motion.div>
                      </Grid.Col>
                    </Grid>
                  </Paper>
