            ...
            ZStack{
                ...
                if !isClicked{
                    Form{
                        ...
                        //first name
                        Section(header: Text("First Name").font(.system(size: 16, weight: .bold)).foregroundStyle(.flexibleBlack)){
                            VStack{
                                TextField(
                                    "", text: $first_name
                                )
                        ...
                        //last name
                        Section(header: Text("Last Name").font(.system(size: 16, weight: .bold)).foregroundStyle(.flexibleBlack)){
                            VStack{
                                TextField(
                                    "", text: $last_name
                                )
                        ...
                        //date of birth
                        Section(header: Text("Date of Birth").font(.system(size: 16, weight: .bold)).foregroundStyle(.flexibleBlack)){
                            VStack{
                                TextField(
                                    "", text: $date_of_birth)
                            }
                        ...
                        //email
                        Section(header: Text("Email").font(.system(size: 16, weight: .bold)).foregroundStyle(.flexibleBlack)){
                            VStack{
                                TextField(
                                    "", text: $email
                                )
                        ...
                        //phone number
                        Section(header: Text("Phone Number").font(.system(size: 16, weight: .bold)).foregroundStyle(.flexibleBlack)){
                            VStack{
                                TextField(
                                    "", text: $phone_number
                                )
                        ...
                        //zipcode
                        Section(header: Text("Zipcode").font(.system(size: 16, weight: .bold)).foregroundStyle(.flexibleBlack)){
                            VStack{
                                TextField(
                                    "", text: $zipcode
                                )
                    ...
                    Form{
                        ...
                        //preferred roles
                        Section(header: Text("Preferred Roles").font(.system(size: 16, weight: .bold)).foregroundStyle(.flexibleBlack)){
                            VStack{
                                TextField(
                                    "", text: $roles
                                )
                        ...
                        //availability
                        Section(header: Text("Availability").font(.system(size: 16, weight: .bold)).foregroundStyle(.flexibleBlack)){
                            VStack{
                                TextField(
                                    "", text: $availability
                                )
